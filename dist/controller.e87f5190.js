...
},{"../internals/is-callable":"node_modules/core-js/internals/is-callable.js","../internals/create-non-enumerable-property":"node_modules/core-js/internals/create-non-enumerable-property.js","../internals/make-built-in":"node_modules/core-js/internals/make-built-in.js","../internals/define-global-property":"node_modules/core-js/internals/define-global-property.js"}],"node_modules/core-js/internals/math-trunc.js":[function(require,module,exports) {
var ceil = Math.ceil;
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            id = window.location.hash.slice(1); //this is getting the hash of the Id universally, the slice removes the first character which is #
          ...
          case 8:
            // we are not storing bcus the loadRecipe is not returning anything
            // 2) Rendering recipe
